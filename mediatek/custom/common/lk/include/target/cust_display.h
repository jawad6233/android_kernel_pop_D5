...
#define V2_BAT_100_INDEX   67
	...
	// fwvga 480*854
    //PR660614 [Power charging]Please update the power on/off charging animation modify by zhaolong at 2014-04-25 begin
	// battery capacity rectangle
	#define CAPACITY_LEFT                (181) // battery capacity center
	#define CAPACITY_TOP                 (320)
	#define CAPACITY_RIGHT               (300)
	#define CAPACITY_BOTTOM              (553)

	// first number rectangle
	#define NUMBER_LEFT                  (179) // number //ok
	#define NUMBER_TOP                   (179)
	#define NUMBER_RIGHT                 (217)
	#define NUMBER_BOTTOM                (233)

	// %  rectangle
	#define PERCENT_LEFT                 (255) // percent number_left + 2*number_width ok
	#define PERCENT_TOP                  (179)
	#define PERCENT_RIGHT                (303)
	#define PERCENT_BOTTOM               (233)

	// top animation part
	#define TOP_ANIMATION_LEFT           (181) // top animation
	#define TOP_ANIMATION_TOP            (100)
	#define TOP_ANIMATION_RIGHT          (300)
	#define TOP_ANIMATION_BOTTOM         (124)

	// for old animation
	#define BAR_LEFT            (193)
	#define BAR_TOP             (227)
	#define BAR_RIGHT           (288)
	#define BAR_BOTTOM          (437)
	//PR660614 [Power charging]Please update the power on/off charging animation modify by zhaolong at 2014-04-25 end
