...
#else
//modify by llf 20140320 PR626080 star
#define PPCOUNT_VALUE			0x26//0x07//0x05//0x0A//0x1B	// 发射脉冲个数  modify by zy for 348261
#endif

#define TMD2772_CMM_CONTROL_VALUE 0xE0//0xA0//0x60
#define PROX_FAR_LIMIT_OFFSET  10 //20-def
#define PROX_CLOSE_LIMIT_OFFSET  80 //60-def

//extern int TMD2772_CMM_PPCOUNT_VALUE;
//extern int ZOOM_TIME;
//modify by llf 20140320 PR626080 end
