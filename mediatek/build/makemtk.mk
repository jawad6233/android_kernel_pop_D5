...
CUSTFILES    :=  out/target/common/jrdResAssetsCust
...
ifeq ($(FORCE_BUILD),TRUE)
	$(hide) echo Cleaning the flag files...
	$(hide) rm -rf $(CUSTFILES)/$(TARGET_PRODUCT)/flag
	$(hide) echo Cleaning the cust files...
	$(hide) rm -rf $(CUSTFILES)/$(TARGET_PRODUCT)/$(MM_PATH)
endif
