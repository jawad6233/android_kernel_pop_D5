    ...
    )
{
    ...
    //pr638879 Wifi can't seach any AP even open wifi again by jianlin.li at 2014-04-10 begin
    set_bit(GLUE_FLAG_INT_BIT, &(prAdapter->prGlueInfo)->u4Flag);
    //pr638879 Wifi can't seach any AP even open wifi again by jianlin.li at 2014-04-10 end
