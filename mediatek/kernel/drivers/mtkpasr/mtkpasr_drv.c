...
retry:
	...
	if (!list_empty(&tolist)) {
		...
		if (mtkpasr_last_scan < mtkpasr_migration_end) {
			...
			mtkpasr_admit_order = -1; //Modified By ming.chen.hz 2014-09-28 for MTK patch. PR 792530 begin
			return NULL;
		}
...
//Modified By ming.chen.hz 2014-09-28 for MTK patch. PR 792530 begin
...
//Modified By ming.chen.hz 2014-09-28 for MTK patch. PR 792530 end
