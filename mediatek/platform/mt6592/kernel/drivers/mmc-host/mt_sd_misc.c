...
/* porting P49_For_JRDHZ92_CW_HZ_KK_ALPS.KK1.MP1.V2.10_P49_.tar.gz at [2014.12.09] by [peng.tian.hz] begin */
    if(!msdc_ctl)
        return -EINVAL; 
    if(msdc_ctl->total_size <= 0)
        return -EINVAL; 
/* porting P49_For_JRDHZ92_CW_HZ_KK_ALPS.KK1.MP1.V2.10_P49_.tar.gz at [2014.12.09] by [peng.tian.hz] end */        
