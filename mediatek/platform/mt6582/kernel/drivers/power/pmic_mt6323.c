...
// Porting Patch JRD695079(For_JRDHZ92_CW_KK_ALPS.KK1.MP1.V2.10_P74)
...
void chrdet_int_handler(void)
{
    ...
    if (!upmu_get_rgs_chrdet())
    {
        ...
        { 
        /*[PR699009][Soul45][charge]capacity dispaly error by [wangxingxing] at [20140610] start*/
            ...
            mt_power_off();
       /*[PR699009][Soul45][charge]capacity dispaly error by [wangxingxing] at [20140610] end*/
        }
    }
#endif
    do_chrdet_int_task();
